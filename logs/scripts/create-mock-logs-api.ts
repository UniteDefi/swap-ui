// Mock logs data for testing the enhanced logs UI
// This bypasses AWS and provides sample data directly
...
export const mockLogs = [
  ...
  },
  {
    ...
    data: {
      ...
      deploySrcTxHash: "0x0929...a3cb",
      deployDstTxHash: "0x77a5...32a2",
      srcChainId: 97,
      dstChainId: 11155111,
      gasUsed: {
        src: "165432",
...
export function getMockLogsForTrade(tradeId: string) {
  return mockLogs.filter(log => log.tradeId === tradeId);
}